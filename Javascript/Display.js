...
Display.setTime = function(time)
{
   ...
   // document.getElementById("progressBar").style.width = timePercent-1 + "%";
	...
	//********************************************************************
		//alert(this.totalTime); // длина трека секунд
		//alert(time);           // время проигрывания секунд
	//********************************************************************
